...
public class SpawnController : NetworkBehaviour {
	...
	public GameObject legendPlayerPrefab;
...
//
//			if(i == playerStart)
//				o = (GameObject) Instantiate (roguePlayerPrefab, spawnPoints[i].transform.position, spawnPoints[i].transform.rotation);
//				
//			else
...
//		ControllerScript script = GameObject.Find("RoguePlayer").GetComponent<ControllerScript> ();
//		if (script.getCamera () == null)
//			script.startCamera = GameObject.Find ("RogueCamera1").GetComponent<Camera> ();
	}
